...
function RenderStationBrowseModal(filterQuery) {
    ...
    groups.forEach(function(g) {
        ...
        html += '<div class="StationBrowseRow StationTableRow" onclick="CommitStationBrowseSelection(\'' + g.Key.replace(/'/g, "\\'") + '\')">' +
            '<div class="StationBrowseRowName">' + g.Label + '</div>' +
            '<div class="StationBrowseRowArea">' + StationRegionHtml(g.Region) + '</div>' +
